...
def generate_launch_description():
    default_params_file = os.path.join(
        get_package_share_directory("inspection_robot_simulation"),
        "config",
        "nav2_sim.yaml",
    )
    behavior_tree_dir = os.path.join(
    ...
    velocity_smoother_feedback = LaunchConfiguration("velocity_smoother_feedback")
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                ...
                description="Velocity smoother feedback mode (OPEN_LOOP or CLOSED_LOOP)",
            ),
            nav2_node(
                "nav2_controller",
                "controller_server",
            ...
            nav2_node(
                ...
                "velocity_smoother",
                parameters + [{"feedback": velocity_smoother_feedback}],
                log_level,
                use_respawn,
